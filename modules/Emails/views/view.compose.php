...
class EmailsViewCompose extends ViewEdit
{
    ...
    public function preDisplay()
    {
        ...
        $this->bean->parent_type = $_GET['related_module'];
        $this->bean->parent_id = $_GET['related_record'];
        if(isset($_GET['related_module']) && isset($_GET['related_record'])) {
        ?>
        <script>
            $(document).ready(function(){
                $('#parent_name').parent().parent().hide();
                $('#parent_name').parent().parent().prev().hide();
        ...
        $this->ev->ss->assign("RELATED_MODULE", isset($_GET['related_module']) ? $_GET['related_module'] : '');
        $this->ev->ss->assign("RELATED_RECORD", isset($_GET['related_record']) ? $_GET['related_record'] : '');
