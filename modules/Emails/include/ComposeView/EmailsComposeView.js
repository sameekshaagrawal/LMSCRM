          ...
          if ($(self).find('input[type="hidden"][name="return_module"]').val() !== '') {
            mb.on('ok', function () {
             ...
             /* var module = $('#' + self.attr('id') + ' input[type="hidden"][name="return_module"]').val();
              ...
              var module = $('#' + self.attr('id') + ' input[name="related_module"]').val();
              if (module !== undefined) {
                url = url + 'module=' + module;
              }
              ...
              var record = $('#' + self.attr('id') + ' input[name="related_record"]').val();
              if (record !== undefined) {
                url = url + '&record=' + record;
              }
              window.close();
             ...
             // window.parent.location.href = "index.php?module=Leads&offset=1&stamp=1628783050092624500&return_module=Leads&action=DetailView&record=6cf28c49-633c-639a-a4b8-610b8954d6b0";
            });
          } else {
            mb.on('ok', function () {
